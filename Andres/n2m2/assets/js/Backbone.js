<!DOCTYPE html>
<!-- saved from url=(0022)http://backbonejs.org/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  
  <meta http-equiv="X-UA-Compatible" content="chrome=1">
  <meta name="viewport" content="width=device-width">
  <link rel="canonical" href="./Backbone_files/Backbone.js">
...
<body>
  ...
  <div id="sidebar" class="interface">
    ...
    <a class="toc_title" href="http://backbonejs.org/#introduction">
      Introduction
    </a>

    <a class="toc_title" href="http://backbonejs.org/#upgrading">
      Upgrading
    </a>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#Events-on">on</a></li>
      <li>– <a href="http://backbonejs.org/#Events-off">off</a></li>
      <li>– <a href="http://backbonejs.org/#Events-trigger">trigger</a></li>
      <li>– <a href="http://backbonejs.org/#Events-once">once</a></li>
      <li>– <a href="http://backbonejs.org/#Events-listenTo">listenTo</a></li>
      <li>– <a href="http://backbonejs.org/#Events-stopListening">stopListening</a></li>
      <li>– <a href="http://backbonejs.org/#Events-listenToOnce">listenToOnce</a></li>
      <li>- <a href="http://backbonejs.org/#Events-catalog"><b>Catalog of Built-in Events</b></a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#Model-extend">extend</a></li>
      <li>– <a href="http://backbonejs.org/#Model-constructor">constructor / initialize</a></li>
      <li>– <a href="http://backbonejs.org/#Model-get">get</a></li>
      <li>– <a href="http://backbonejs.org/#Model-set">set</a></li>
      <li>– <a href="http://backbonejs.org/#Model-escape">escape</a></li>
      <li>– <a href="http://backbonejs.org/#Model-has">has</a></li>
      <li>– <a href="http://backbonejs.org/#Model-unset">unset</a></li>
      <li>– <a href="http://backbonejs.org/#Model-clear">clear</a></li>
      <li>– <a href="http://backbonejs.org/#Model-id">id</a></li>
      <li>– <a href="http://backbonejs.org/#Model-idAttribute">idAttribute</a></li>
      <li>– <a href="http://backbonejs.org/#Model-cid">cid</a></li>
      <li>– <a href="http://backbonejs.org/#Model-attributes">attributes</a></li>
      <li>– <a href="http://backbonejs.org/#Model-changed">changed</a></li>
      <li>– <a href="http://backbonejs.org/#Model-defaults">defaults</a></li>
      <li>– <a href="http://backbonejs.org/#Model-toJSON">toJSON</a></li>
      <li>– <a href="http://backbonejs.org/#Model-sync">sync</a></li>
      <li>– <a href="http://backbonejs.org/#Model-fetch">fetch</a></li>
      <li>– <a href="http://backbonejs.org/#Model-save">save</a></li>
      <li>– <a href="http://backbonejs.org/#Model-destroy">destroy</a></li>
      <li>– <a href="http://backbonejs.org/#Model-Underscore-Methods"><b>Underscore Methods (6)</b></a></li>
      <li>– <a href="http://backbonejs.org/#Model-validate">validate</a></li>
      <li>– <a href="http://backbonejs.org/#Model-validationError">validationError</a></li>
      <li>– <a href="http://backbonejs.org/#Model-isValid">isValid</a></li>
      <li>– <a href="http://backbonejs.org/#Model-url">url</a></li>
      <li>– <a href="http://backbonejs.org/#Model-urlRoot">urlRoot</a></li>
      <li>– <a href="http://backbonejs.org/#Model-parse">parse</a></li>
      <li>– <a href="http://backbonejs.org/#Model-clone">clone</a></li>
      <li>– <a href="http://backbonejs.org/#Model-isNew">isNew</a></li>
      <li>– <a href="http://backbonejs.org/#Model-hasChanged">hasChanged</a></li>
      <li>– <a href="http://backbonejs.org/#Model-changedAttributes">changedAttributes</a></li>
      <li>– <a href="http://backbonejs.org/#Model-previous">previous</a></li>
      <li>– <a href="http://backbonejs.org/#Model-previousAttributes">previousAttributes</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#Collection-extend">extend</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-model">model</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-constructor">constructor / initialize</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-models">models</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-toJSON">toJSON</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-sync">sync</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-Underscore-Methods"><b>Underscore Methods (28)</b></a></li>
      ...
      <li>– <a href="http://backbonejs.org/#Collection-url">url</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-parse">parse</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-clone">clone</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-fetch">fetch</a></li>
      <li>– <a href="http://backbonejs.org/#Collection-create">create</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#Router-extend">extend</a></li>
      <li>– <a href="http://backbonejs.org/#Router-routes">routes</a></li>
      <li>– <a href="http://backbonejs.org/#Router-constructor">constructor / initialize</a></li>
      <li>– <a href="http://backbonejs.org/#Router-route">route</a></li>
      <li>– <a href="http://backbonejs.org/#Router-navigate">navigate</a></li>
      <li>– <a href="http://backbonejs.org/#Router-execute">execute</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#History-start">start</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#Sync">Backbone.sync</a></li>
      <li>– <a href="http://backbonejs.org/#Sync-ajax">Backbone.ajax</a></li>
      <li>– <a href="http://backbonejs.org/#Sync-emulateHTTP">Backbone.emulateHTTP</a></li>
      <li>– <a href="http://backbonejs.org/#Sync-emulateJSON">Backbone.emulateJSON</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#View-extend">extend</a></li>
      <li>– <a href="http://backbonejs.org/#View-constructor">constructor / initialize</a></li>
      <li>– <a href="http://backbonejs.org/#View-el">el</a></li>
      <li>– <a href="http://backbonejs.org/#View-$el">$el</a></li>
      <li>– <a href="http://backbonejs.org/#View-setElement">setElement</a></li>
      <li>– <a href="http://backbonejs.org/#View-attributes">attributes</a></li>
      <li>– <a href="http://backbonejs.org/#View-dollar">$ (jQuery)</a></li>
      <li>– <a href="http://backbonejs.org/#View-template">template</a></li>
      <li>– <a href="http://backbonejs.org/#View-render">render</a></li>
      <li>– <a href="http://backbonejs.org/#View-remove">remove</a></li>
      <li>– <a href="http://backbonejs.org/#View-delegateEvents">delegateEvents</a></li>
      <li>– <a href="http://backbonejs.org/#View-undelegateEvents">undelegateEvents</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#Utility-Backbone-noConflict">Backbone.noConflict</a></li>
      <li>– <a href="http://backbonejs.org/#Utility-Backbone-$">Backbone.$</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#FAQ-why-backbone">Why Backbone?</a></li>
      <li>– <a href="http://backbonejs.org/#FAQ-tim-toady">More Than One Way To Do It</a></li>
      <li>– <a href="http://backbonejs.org/#FAQ-nested">Nested Models &amp; Collections</a></li>
      <li>– <a href="http://backbonejs.org/#FAQ-bootstrap">Loading Bootstrapped Models</a></li>
      <li>– <a href="http://backbonejs.org/#FAQ-extending">Extending Backbone</a></li>
      <li>– <a href="http://backbonejs.org/#FAQ-mvc">Traditional MVC</a></li>
      <li>– <a href="http://backbonejs.org/#FAQ-this">Binding "this"</a></li>
      <li>– <a href="http://backbonejs.org/#FAQ-rails">Working with Rails</a></li>
    </ul>
    ...
    <ul class="toc_section">
      <li>– <a href="http://backbonejs.org/#examples-todos">Todos</a></li>
      <li>– <a href="http://backbonejs.org/#examples-documentcloud">DocumentCloud</a></li>
      <li>– <a href="http://backbonejs.org/#examples-usa-today">USA Today</a></li>
      <li>– <a href="http://backbonejs.org/#examples-rdio">Rdio</a></li>
      <li>– <a href="http://backbonejs.org/#examples-hulu">Hulu</a></li>
      <li>– <a href="http://backbonejs.org/#examples-quartz">Quartz</a></li>
      <li>– <a href="http://backbonejs.org/#examples-earth">Earth</a></li>
      <li>– <a href="http://backbonejs.org/#examples-vox">Vox</a></li>
      <li>– <a href="http://backbonejs.org/#examples-gawker">Gawker Media</a></li>
      <li>– <a href="http://backbonejs.org/#examples-flow">Flow</a></li>
      <li>– <a href="http://backbonejs.org/#examples-gilt">Gilt Groupe</a></li>
      <li>– <a href="http://backbonejs.org/#examples-enigma">Enigma</a></li>
      <li>– <a href="http://backbonejs.org/#examples-newsblur">NewsBlur</a></li>
      <li>– <a href="http://backbonejs.org/#examples-wordpress">WordPress.com</a></li>
      <li>– <a href="http://backbonejs.org/#examples-foursquare">Foursquare</a></li>
      <li>– <a href="http://backbonejs.org/#examples-bitbucket">Bitbucket</a></li>
      <li>– <a href="http://backbonejs.org/#examples-disqus">Disqus</a></li>
      <li>– <a href="http://backbonejs.org/#examples-delicious">Delicious</a></li>
      <li>– <a href="http://backbonejs.org/#examples-khan-academy">Khan Academy</a></li>
      <li>– <a href="http://backbonejs.org/#examples-irccloud">IRCCloud</a></li>
      <li>– <a href="http://backbonejs.org/#examples-pitchfork">Pitchfork</a></li>
      <li>– <a href="http://backbonejs.org/#examples-spin">Spin</a></li>
      <li>– <a href="http://backbonejs.org/#examples-zocdoc">ZocDoc</a></li>
      <li>– <a href="http://backbonejs.org/#examples-walmart">Walmart Mobile</a></li>
      <li>– <a href="http://backbonejs.org/#examples-groupon">Groupon Now!</a></li>
      <li>– <a href="http://backbonejs.org/#examples-basecamp">Basecamp</a></li>
      <li>– <a href="http://backbonejs.org/#examples-slavery-footprint">Slavery Footprint</a></li>
      <li>– <a href="http://backbonejs.org/#examples-stripe">Stripe</a></li>
      <li>– <a href="http://backbonejs.org/#examples-airbnb">Airbnb</a></li>
      <li>– <a href="http://backbonejs.org/#examples-diaspora">Diaspora</a></li>
      <li>– <a href="http://backbonejs.org/#examples-soundcloud">SoundCloud Mobile</a></li>
      <li>- <a href="http://backbonejs.org/#examples-artsy">Art.sy</a></li>
      <li>– <a href="http://backbonejs.org/#examples-pandora">Pandora</a></li>
      <li>– <a href="http://backbonejs.org/#examples-inkling">Inkling</a></li>
      <li>– <a href="http://backbonejs.org/#examples-code-school">Code School</a></li>
      <li>– <a href="http://backbonejs.org/#examples-cloudapp">CloudApp</a></li>
      <li>– <a href="http://backbonejs.org/#examples-seatgeek">SeatGeek</a></li>
      <li>– <a href="http://backbonejs.org/#examples-easel">Easel</a></li>
      <li>- <a href="http://backbonejs.org/#examples-jolicloud">Jolicloud</a></li>
      <li>– <a href="http://backbonejs.org/#examples-salon">Salon.io</a></li>
      <li>– <a href="http://backbonejs.org/#examples-tilemill">TileMill</a></li>
      <li>– <a href="http://backbonejs.org/#examples-blossom">Blossom</a></li>
      <li>– <a href="http://backbonejs.org/#examples-trello">Trello</a></li>
      <li>– <a href="http://backbonejs.org/#examples-tzigla">Tzigla</a></li>
    </ul>
  ...
  <div class="container">
    ...
    <table>
      <tbody><tr>
        <td><a class="punch" href="./Backbone_files/backbone.js">Development Version (1.1.2)</a></td>
        <td class="text"><i>60kb, Full source, tons of comments</i></td>
      </tr>
      <tr>
        <td><a class="punch" href="http://backbonejs.org/backbone-min.js">Production Version (1.1.2)</a></td>
    ...
    <p>
      ...
      For RESTful persistence, history support via <a href="http://backbonejs.org/#Router">Backbone.Router</a>
      and DOM manipulation with <a href="http://backbonejs.org/#View">Backbone.View</a>, include
    ...
    <p>
      ...
      <a href="http://backbonejs.org/#changelog">change log</a>. In brief, a few of the larger breaking
      changes are:
    </p>
    ...
    <ul>
      <li>
        ...
        you now call <a href="http://backbonejs.org/#Collection-set">set</a> (previously named "update"),
        a similar operation to calling <tt>set</tt> on a Model. This is now the
        default when you call <a href="http://backbonejs.org/#Collection-fetch">fetch</a> on a collection.
      ...
      <li>
        ...
        <a href="http://backbonejs.org/#Events-listenTo">listenTo</a> and
        <a href="http://backbonejs.org/#Events-stopListening">stopListening</a>, which make it easier
        to create Views that have all of their observers unbound when you
        want to <a href="http://backbonejs.org/#View-remove">remove</a> the view.
      </li>
      <li>
        Model validation is now only enforced by default in
        <a href="http://backbonejs.org/#Model-save">save</a> — not in
        <a href="http://backbonejs.org/#Model-set">set</a> unless the <tt>{validate:true}</tt>
...
object.off();
    ...
    <p id="Events-once">
      ...
      <br>
      Just like <a href="http://backbonejs.org/#Events-on">on</a>, but causes the bound callback to only
...
alert("Cake id: " + cake.id);
    ...
    <p id="Model-changed">
      ...
      that have changed since the last <a href="http://backbonejs.org/#Model-set">set</a>.
...
alert(JSON.stringify(artist));
    ...
    <p id="Model-fetch">
      ...
      <a href="http://backbonejs.org/#Sync">Backbone.sync</a>. Returns a
...
<pre>ActiveRecord::Base.include_root_in_json = false
    ...
    <p id="Model-hasChanged">
      ...
      <br>
      Has the model changed since the last <a href="http://backbonejs.org/#Model-set">set</a>? If an <b>attribute</b>
...
var alphabetical = books.sortBy(function(book) {
  return book.author.get("name").toLowerCase();
    ...
    <p id="Collection-add">
      ...
      event. If a <a href="http://backbonejs.org/#Collection-model">model</a> property is defined, you may also pass
...
<pre>ActiveRecord::Base.include_root_in_json = false
    ...
    <b class="header">1.0.0</b> — <small><i>March 20, 2013</i></small> — <a href="https://github.com/jashkenas/backbone/compare/0.9.10...1.0.0">Diff</a> — <a href="http://htmlpreview.github.com/?https://raw.github.com/jashkenas/backbone/1.0.0/index.html">Docs</a><br>
    <ul style="margin-top: 5px;">
      <li>
    ...
    <b class="header">0.9.10</b> — <small><i>Jan. 15, 2013</i></small> — <a href="https://github.com/jashkenas/backbone/compare/0.9.9...0.9.10">Diff</a> — <a href="http://htmlpreview.github.com/?https://raw.github.com/jashkenas/backbone/0.9.10/index.html">Docs</a><br>
    <ul style="margin-top: 5px;">
      <li>
  ...
  <script src="./Backbone_files/underscore.js"></script>
  <script src="./Backbone_files/jquery.js"></script>
  <script src="./Backbone_files/jquery.lazyload.js"></script>
  <script src="./Backbone_files/json2.js"></script>
  <script src="./Backbone_files/backbone.js"></script>
